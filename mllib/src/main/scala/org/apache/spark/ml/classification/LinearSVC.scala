 ...
 * By default, L1 SVM (Hinge Loss) and OWLQN optimizer are used.
 *
 */
@Since("2.2.0")
class LinearSVC @Since("2.2.0") (
  ...
  setDefault(loss -> HINGE)

  /**
   * Set solver for LinearSVC. Supported options: "l-bfgs" and "owlqn" (case insensitive).
